...
export const DICT = {
  zh: {
    ...
    importCenter: '导入中心', directives: '策略指令', translate: '翻译配置', upstream: '上游服务', devicesRemote: '设备与远程指令',
  ...
  en: {
    ...
    importCenter: 'Import Center', directives: 'Directives', translate: 'Translate', upstream: 'Upstream', devicesRemote: 'Devices & Remote',
